...
namespace Stonepaw.LibraryOrganizer.Utilities
{
    /// <summary>
    ...
    public static class IconTools
    {
        ...
        internal const int SHGFI_EXTRALARGEICON = 0x2;
        /// <summary>
    ...
    public enum ShellIconSize : uint
    {
        ...
        /// <summary>
        /// Specified a extra large (48x48) icon
        /// </summary>
        ExtraLargeIcon = IconTools.SHGFI_ICON | IconTools.SHGFI_EXTRALARGEICON
    }
}